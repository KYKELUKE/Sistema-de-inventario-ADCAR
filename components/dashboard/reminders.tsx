...
export function Reminders() {
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-foreground mb-6">Alertas Importantes</h2>
      <div className="space-y-4">
        <div className="bg-card border border-border rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
          <h3 className="font-semibold text-foreground mb-1">Stock Crítico: Mouse Inalámbrico</h3>
          <p className="text-sm text-muted-foreground mb-4">Solo 3 unidades disponibles</p>
