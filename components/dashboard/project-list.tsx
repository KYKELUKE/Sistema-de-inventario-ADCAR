...
const projects = [
  { name: "Laptop Dell XPS 15", date: "Stock: 12", color: "bg-blue-500", icon: "💻" },
  { name: "Monitor LG 27\" 4K", date: "Stock: 8", color: "bg-cyan-500", icon: "🖥️" },
  { name: "Teclado Mecánico RGB", date: "Stock: 45", color: "bg-purple-500", icon: "⌨️" },
  { name: "Mouse Inalámbrico", date: "Stock: 3 (Bajo)", color: "bg-amber-500", icon: "🖱️" },
  { name: "Cable HDMI 2.1", date: "Stock: 156", color: "bg-emerald-500", icon: "🔌" },
]
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-foreground">Productos Principales</h2>
